...
//! @file common.cxx
//! @brief Boolean Common (intersection of two argument groups).
...
OCCTL_API occtl_status_t OCCTL_CALL occtl_bool_common(occtl_graph_t* const              graph,
                                                      ...
                                                      occtl_node_id_t* const            out_root)
{
  return OcctL::Core::Guard([&]() -> occtl_status_t {
    ...
    return OcctL::Bool::RunAndCommit(graph, opts, out_root, "Common", anInputsMap, anAlgo);
  });
}
