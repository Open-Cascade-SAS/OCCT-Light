...
//! @file cut.cxx
//! @brief Boolean Cut: objects minus tools.
...
OCCTL_API occtl_status_t OCCTL_CALL occtl_bool_cut(occtl_graph_t* const              graph,
                                                   ...
                                                   occtl_node_id_t* const            out_root)
{
  return OcctL::Core::Guard([&]() -> occtl_status_t {
    ...
    return OcctL::Bool::RunAndCommit(graph, opts, out_root, "Cut", anInputsMap, anAlgo);
  });
}
